...
{
    CMOpenALSoundManager *soundMgr = (CMOpenALSoundManager *) CFBridgingRelease(inUserData);
...
- (id) init
{
	...
	{		
		...
		OSStatus status = AudioSessionInitialize(NULL, NULL, interruptionListenerCallback, CFBridgingRetain(self));
