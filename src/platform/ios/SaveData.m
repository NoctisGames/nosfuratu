...
static NSString *NUM_GOLDEN_CARROTS = @"v1_num_golden_carrots";
static NSString *JON_UNLOCKED_ABILITIES_FLAG = @"v1_jon_unlocked_abilities_flag";
static NSString *VIEWED_CUTSCENES_FLAG = @"v1_viewed_cutscenes_flag";
