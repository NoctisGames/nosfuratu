...
extern "C"
{
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_init_1sound_1manager(JNIEnv* env, jclass cls, jint sample_rate, jint buffer_size);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_load_1sound(JNIEnv* env, jclass cls, jint rawResourceId, jstring apk_path, jint num_copies, jint fileOffset, jint fileLength);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_play_1sound(JNIEnv* env, jclass cls, jint rawResourceId, jfloat volume, jboolean isLooping);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_stop_1sound(JNIEnv* env, jclass cls, jint rawResourceId);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_resume_1all_1sounds(JNIEnv* env, jclass cls);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_pause_1all_1sounds(JNIEnv* env, jclass cls);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_stop_1all_1sounds(JNIEnv* env, jclass cls);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_stop_1all_1looping_1sounds(JNIEnv* env, jclass cls);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_load_1music(JNIEnv* env, jclass cls, jint rawResourceId, jstring apk_path, jint fileOffset, jint fileLength);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_play_1music(JNIEnv* env, jclass cls, jfloat volume, jboolean isLooping);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_set_1music_1volume(JNIEnv* env, jclass cls, jfloat volume);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_resume_1music(JNIEnv* env, jclass cls);
    
    JNIEXPORT void JNICALL Java_com_noctisgames_nosfuratu_SoundManager_pause_1music(JNIEnv* env, jclass cls);
};
