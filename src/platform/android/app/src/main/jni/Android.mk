...
LOCAL_MODULE    := game
LOCAL_CFLAGS    := -Wall -Wextra -DNG_OPENGL_ES -DNG_ANDROID -DGL_GLEXT_PROTOTYPES=1
...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGLES_RELATIVE_PATH)/OpenGLESEndBossSnakeTextureGpuProgramWrapper.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGLES_RELATIVE_PATH)/OpenGLESFadeScreenGpuProgramWrapper.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGLES_RELATIVE_PATH)/OpenGLESFramebufferObfuscationGpuProgramWrapper.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGLES_RELATIVE_PATH)/OpenGLESPointTransScreenGpuProgramWrapper.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGLES_RELATIVE_PATH)/PointTransitionProgram.cpp
