...
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_UI_RELATIVE_PATH)/PointTransitionGpuProgramWrapper.cpp
...
LOCAL_SRC_FILES += $(CORE_FRAMEWORK_UI_OPENGL_RELATIVE_PATH)/OpenGLPointTransScreenGpuProgramWrapper.cpp
