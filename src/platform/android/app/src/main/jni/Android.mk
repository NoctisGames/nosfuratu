...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_RELATIVE_PATH)/OpenGLFramebufferObfuscationGpuProgramWrapper.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_RELATIVE_PATH)/OpenGLRenderer.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_RELATIVE_PATH)/OpenGLShockwaveTextureGpuProgramWrapper.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_RELATIVE_PATH)/OpenGLSinWaveTextureGpuProgramWrapper.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_RELATIVE_PATH)/SinWaveTextureProgram.cpp
...
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_RELATIVE_PATH)/TransitionProgram.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_ANDROID_RELATIVE_PATH)/AndroidOpenGLGameScreen.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_ANDROID_RELATIVE_PATH)/SuperpoweredSound.cpp
LOCAL_SRC_FILES += $(CORE_GAME_UI_OPENGL_ANDROID_RELATIVE_PATH)/SuperpoweredSoundManager.cpp
