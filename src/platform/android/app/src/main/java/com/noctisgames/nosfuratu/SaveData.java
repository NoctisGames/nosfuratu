...
public final class SaveData
{
    ...
    private static final String JON_UNLOCKED_ABILITIES_FLAG = "v0_9_9_jon_unlocked_abilities_flag";
    private static final String VIEWED_CUTSCENES_FLAG = "v0_9_9_viewed_cutscenes_flag";
