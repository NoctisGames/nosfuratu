...
Direct3DBackgroundTextureGpuProgramWrapper::Direct3DBackgroundTextureGpuProgramWrapper(const std::shared_ptr<DX::DeviceResources>& deviceResources) : m_iNumShadersLoaded(0), m_deviceResources(deviceResources)
{
...
void Direct3DBackgroundTextureGpuProgramWrapper::bind()
{
	...
	m_deviceResources->GetD3DDeviceContext()->PSSetSamplers(0, 1, D3DManager->m_sbWrapSamplerState.GetAddressOf());
...
void Direct3DBackgroundTextureGpuProgramWrapper::cleanUp()
{
