...
Direct3DGameScreen::Direct3DGameScreen(const std::shared_ptr<DX::DeviceResources>& deviceResources, bool isMobile, bool useCompressedTextureSet) : GameScreen(true), m_deviceResources(deviceResources)
{
