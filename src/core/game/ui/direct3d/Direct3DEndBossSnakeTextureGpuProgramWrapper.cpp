...
Direct3DEndBossSnakeTextureGpuProgramWrapper::Direct3DEndBossSnakeTextureGpuProgramWrapper(const std::shared_ptr<DX::DeviceResources>& deviceResources) : m_iNumShadersLoaded(0), m_deviceResources(deviceResources)
{
	// Load shaders asynchronously.
	auto loadVSTask = DX::ReadDataAsync(L"TextureVertexShader.cso");
	auto loadPSTask = DX::ReadDataAsync(L"EndBossSnakeTexturePixelShader.cso");
...
void Direct3DEndBossSnakeTextureGpuProgramWrapper::cleanUp()
{
