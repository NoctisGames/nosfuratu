...
OpenGLESGameScreen::OpenGLESGameScreen(bool isLowMemoryDevice, bool isUsingDesktopTextureSet) : GameScreen(), m_isLowMemoryDevice(isLowMemoryDevice), m_isUsingDesktopTextureSet(isUsingDesktopTextureSet)
{
    // Empty
}
