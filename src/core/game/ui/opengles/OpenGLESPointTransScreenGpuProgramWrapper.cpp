//
//  OpenGLESPointTransScreenGpuProgramWrapper.cpp
//  nosfuratu
//
...
OpenGLESPointTransScreenGpuProgramWrapper::OpenGLESPointTransScreenGpuProgramWrapper() : PointTransitionGpuProgramWrapper()
{
...
void OpenGLESPointTransScreenGpuProgramWrapper::bind()
{
...
void OpenGLESPointTransScreenGpuProgramWrapper::unbind()
{
    glActiveTexture(GL_TEXTURE1);
...
void OpenGLESPointTransScreenGpuProgramWrapper::cleanUp()
{
