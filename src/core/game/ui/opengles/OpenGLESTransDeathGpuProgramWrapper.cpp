//
//  OpenGLESTransDeathGpuProgramWrapper.cpp
//  nosfuratu
//
...
OpenGLESTransDeathGpuProgramWrapper::OpenGLESTransDeathGpuProgramWrapper(bool isTransIn) : TransDeathGpuProgramWrapper(isTransIn)
{
...
void OpenGLESTransDeathGpuProgramWrapper::bind()
{
...
void OpenGLESTransDeathGpuProgramWrapper::unbind()
{
    glActiveTexture(GL_TEXTURE1);
...
void OpenGLESTransDeathGpuProgramWrapper::cleanUp()
{
