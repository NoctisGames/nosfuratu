//
//  OpenGLESFadeScreenGpuProgramWrapper.cpp
//  nosfuratu
//
...
#include "OpenGLESFadeScreenGpuProgramWrapper.h"
...
OpenGLESFadeScreenGpuProgramWrapper::OpenGLESFadeScreenGpuProgramWrapper() : TransitionGpuProgramWrapper()
{
    m_program = TransitionProgram::build(build_program_from_assets("frame_buffer_to_screen_shader.vsh", "fade_screen_shader.fsh"));
    m_isLoaded = true;
}

void OpenGLESFadeScreenGpuProgramWrapper::bind()
{
...
void OpenGLESFadeScreenGpuProgramWrapper::unbind()
{
    glActiveTexture(GL_TEXTURE1);
...
void OpenGLESFadeScreenGpuProgramWrapper::cleanUp()
{
