...
GameScreen::GameScreen(bool isLevelEditor) : m_isLevelEditor(isLevelEditor), m_fDeltaTime(0), m_isRequestingRender(false), m_iRequestedAction(REQUESTED_ACTION_UPDATE)
{
