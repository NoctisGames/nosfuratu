...
void MainAssetsMapper::mapAssets()
{
    ...
    ASSETS->getTextureRegionMap()["MidgroundType_Stone_Square"] = new TextureRegion("world_1_objects_part_2", 1298, 3688, 384, 384, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["LevelCompletePanel"] = new TextureRegion("world_1_objects_part_1", 1680, 2204, 768, 592, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["LevelCompletePanel_Enemy"] = new TextureRegion("world_1_objects_part_1", 2500, 2624, 72, 72, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Plant"] = new TextureRegion("world_1_objects_part_2", 2234, 3456, 336, 384, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_PassThrough"] = new TextureRegion("world_1_objects_part_2", 256, 3582, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Bottom_PassThrough"] = new TextureRegion("world_1_objects_part_2", 0, 3838, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Window_PassThrough"] = new TextureRegion("world_1_objects_part_2", 0, 3582, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Window_Bottom_PassThrough"] = new TextureRegion("world_1_objects_part_2", 256, 3838, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall"] = new TextureRegion("world_1_objects_part_2", 768, 3582, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Bottom"] = new TextureRegion("world_1_objects_part_2", 512, 3838, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Window"] = new TextureRegion("world_1_objects_part_2", 512, 3582, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Window_Bottom"] = new TextureRegion("world_1_objects_part_2", 768, 3838, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Roof_Side_Left"] = new TextureRegion("world_1_objects_part_2", 2142, 3914, 256, 64, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Roof_Side_Right"] = new TextureRegion("world_1_objects_part_2", 2398, 3914, 256, 64, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Roof_Plain"] = new TextureRegion("world_1_objects_part_2", 2142, 3986, 256, 96, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Roof_Chimney"] = new TextureRegion("world_1_objects_part_2", 2398, 3986, 256, 96, TEXTURE_SIZE_4096);
    ...
    ASSETS->getAnimationsMap()["GameButtonContainer"] = new Animation("world_map_screen_part_1", 1104, 120, 104, 384, 520, 384, TEXTURE_SIZE_2048, false, 0.04f, 5);
}
