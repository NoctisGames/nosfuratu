...
void MainAssetsMapper::mapAssets()
{
    ...
    ASSETS->getTextureRegionMap()["MidgroundType_Train_Car"] = new TextureRegion("world_1_objects_part_2", 528, 2798, 1568, 384, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["MidgroundType_Tall_Stump"] = new TextureRegion("world_1_objects_part_2", 604, 1278, 128, 192, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["MidgroundType_Thin_Tall_Tree"] = new TextureRegion("world_1_objects_part_2", 604, 1488, 192, 512, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["MidgroundType_Thin_Short_Tree"] = new TextureRegion("world_1_objects_part_2", 814, 1128, 256, 320, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["MidgroundType_Wall"] = new TextureRegion("world_1_objects_part_2", 1024, 3810, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["MidgroundType_Roof"] = new TextureRegion("world_1_objects_part_2", 1024, 3746, 256, 64, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["HoleType_GrassTileLeft"] = new TextureRegion("world_1_objects_part_1", 0, 1400, 256, 368, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["HoleType_GrassTileCenter"] = new TextureRegion("world_1_objects_part_1", 0, 1772, 256, 368, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["HoleType_GrassTileRight"] = new TextureRegion("world_1_objects_part_1", 0, 2144, 256, 368, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["HoleType_Grass"] = new TextureRegion("world_1_objects_part_1", 0, 2528, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["HoleType_Cave"] = new TextureRegion("world_1_objects_part_1", 0, 2788, 272, 384, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["ForegroundObjectType_SpikeTower"] = new TextureRegion("world_1_objects_part_2", 2892, 3200, 512, 896, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundObjectType_SpikeTowerBg"] = new TextureRegion("world_1_objects_part_2", 3408, 3200, 512, 896, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["GameHudCarrot_Golden"] = new TextureRegion("world_1_objects_part_1", 1904, 1254, 96, 112, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["GameHudCarrot_Normal"] = new TextureRegion("world_1_objects_part_1", 884, 1054, 96, 112, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Tree"] = new TextureRegion("world_1_objects_part_2", 0, 2774, 448, 816, TEXTURE_SIZE_4096);
    ...
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Bush"] = new TextureRegion("world_1_objects_part_2", 0, 1484, 400, 240, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Ferns"] = new TextureRegion("world_1_objects_part_2", 0, 1308, 528, 176, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall"] = new TextureRegion("world_1_objects_part_2", 764, 3554, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Bottom"] = new TextureRegion("world_1_objects_part_2", 508, 3810, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Window"] = new TextureRegion("world_1_objects_part_2", 508, 3554, 256, 256, TEXTURE_SIZE_4096);
    ASSETS->getTextureRegionMap()["ForegroundCoverObjectType_Wall_Window_Bottom"] = new TextureRegion("world_1_objects_part_2", 764, 3810, 256, 256, TEXTURE_SIZE_4096);
    ...
    ASSETS->getAnimationsMap()["HoleCoverType_GrassTileLeft"] = new Animation("world_1_objects_part_1", 256, 1400, 256, 368, 2560, 368, TEXTURE_SIZE_4096, false, 0.05f, 10);
    ASSETS->getAnimationsMap()["HoleCoverType_GrassTileCenter"] = new Animation("world_1_objects_part_1", 256, 1772, 256, 368, 2560, 368, TEXTURE_SIZE_4096, false, 0.05f, 10);
    ASSETS->getAnimationsMap()["HoleCoverType_GrassTileRight"] = new Animation("world_1_objects_part_1", 256, 2144, 256, 368, 2560, 368, TEXTURE_SIZE_4096, false, 0.05f, 10);
    ASSETS->getAnimationsMap()["HoleCoverType_Grass"] = new Animation("world_1_objects_part_1", 256, 2528, 256, 256, 3072, 256, TEXTURE_SIZE_4096, false, 0.04166666666667f, 12);
    ASSETS->getAnimationsMap()["HoleCoverType_Cave"] = new Animation("world_1_objects_part_1", 272, 2788, 272, 384, 2720, 384, TEXTURE_SIZE_4096, false, 0.05f, 10);
