...
Assets::Assets() : m_isUsingCompressedTextureSet(false), m_isMusicEnabled(true), m_isSoundEnabled(true)
{
    ...
    m_textureRegions["GameButtonType_ToggleMusic"] = new TextureRegion(1244, 72, 128, 128, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["GameButtonType_ToggleSound"] = new TextureRegion(1244, 204, 128, 128, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["GameButtonType_BackToTitle"] = new TextureRegion(1800, 0, 104, 104, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["GameButtonType_Leaderboards"] = new TextureRegion(1904, 0, 104, 104, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["GameButtonType_ViewOpeningCutscene"] = new TextureRegion(1152, 0, 96, 64, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["GameButtonType_BackToLevelSelect"] = new TextureRegion(0, 0, 104, 104, TEXTURE_SIZE_1024, TEXTURE_SIZE_1024);
    m_textureRegions["GameButtonType_ContinueToLevelSelect"] = new TextureRegion(804, 0, 104, 104, TEXTURE_SIZE_1024, TEXTURE_SIZE_1024);
    m_textureRegions["GameButtonType_LevelEditor"] = new TextureRegion(2848, 2644, 190, 62, TEXTURE_SIZE_4096, TEXTURE_SIZE_4096);
    ...
    m_textureRegions["LevelEditorEntitiesPanel"] = new TextureRegion(0, 46, 592, 1338, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["LevelEditorActionsPanel"] = new TextureRegion(840, 46, 592, 1338, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["TrashCan_Highlighted"] = new TextureRegion(128, 1454, 128, 128, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["TrashCan_Normal"] = new TextureRegion(0, 1454, 128, 128, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["LevelSelectorPanel"] = new TextureRegion(1538, 12, 510, 510, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["OffsetPanel"] = new TextureRegion(1538, 542, 510, 510, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["ConfirmResetPanel"] = new TextureRegion(938, 1484, 510, 510, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    m_textureRegions["ConfirmExitPanel"] = new TextureRegion(1538, 1072, 510, 510, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048);
    ...
    m_animations["AbilitySlot_Unlocking"] = new Animation(0, 458, 118, 114, 1180, 114, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 10);
    m_animations["AbilitySlotType_Drill"] = new Animation(0, 572, 118, 114, 1298, 114, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 11);
    m_animations["AbilitySlotType_Dash"] = new Animation(0, 686, 118, 114, 1298, 114, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 11);
    m_animations["BossLevelThumbnail_Unlocking"] = new Animation(0, 804, 198, 204, 1980, 408, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 13);
    m_animations["BossLevelThumbnail_Selected_Cleared"] = new Animation(198, 1832, 198, 204, 1782, 204, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 9);
    m_animations["BossLevelThumbnail_Selected"] = new Animation(0, 1216, 198, 204, 1782, 204, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 9);
    m_animations["BossLevelThumbnail_Selecting_Cleared"] = new Animation(1386, 1628, 198, 204, 792, 204, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 4);
    m_animations["BossLevelThumbnail_Selecting"] = new Animation(198, 1420, 198, 204, 594, 204, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 3);
    m_animations["BossLevelThumbnail_Clearing"] = new Animation(0, 1628, 198, 204, 1386, 204, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 7);
    m_animations["BossLevelThumbnail_Locked_Jaw_Moving"] = new Animation(990, 1008, 198, 204, 990, 204, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 5, 3);
    m_animations["NormalLevelThumbnail_Selected_Cleared"] = new Animation(744, 330, 124, 124, 1240, 124, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 10);
    m_animations["NormalLevelThumbnail_Selected"] = new Animation(868, 78, 124, 124, 1116, 124, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 9);
    m_animations["NormalLevelThumbnail_Selecting_Cleared"] = new Animation(0, 330, 124, 124, 744, 124, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 6);
    m_animations["NormalLevelThumbnail_Selecting"] = new Animation(124, 78, 124, 124, 744, 124, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 6);
    m_animations["NormalLevelThumbnail_Clearing"] = new Animation(0, 206, 124, 124, 1364, 124, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 11);
    m_animations["GoldenCarrotsMarker_0"] = new Animation(0, 0, 118, 74, 944, 74, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 8);
    m_animations["GoldenCarrotsMarker_1"] = new Animation(0, 0, 118, 74, 1062, 74, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 9);
    m_animations["GoldenCarrotsMarker_2"] = new Animation(0, 0, 118, 74, 1180, 74, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 10);
    m_animations["GoldenCarrotsMarker_3"] = new Animation(0, 0, 118, 74, 1298, 74, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 11);
    m_animations["GoldenCarrotsMarker_4"] = new Animation(0, 0, 118, 74, 1416, 74, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, false, 0.10f, 12);
    m_animations["SpendGoldenCarrotsBubble_Has_Enough"] = new Animation(0, 748, 234, 184, 1872, 552, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 21, 3);
    m_animations["SpendGoldenCarrotsBubble_Not_Enough"] = new Animation(0, 1304, 234, 184, 1872, 552, TEXTURE_SIZE_2048, TEXTURE_SIZE_2048, true, 0.10f, 21, 3);
