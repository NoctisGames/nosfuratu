...
m_jon(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_jon" : "jon", true)),
m_level_editor(new TextureWrapper("level_editor", true)),
m_misc(new TextureWrapper("misc", true)),
m_title_screen(new TextureWrapper("title_screen", true)),
m_trans_death_shader_helper(new TextureWrapper("trans_death_shader_helper", true)),
m_tutorial(new TextureWrapper(MAIN_ASSETS->isUsingGamePadTextureSet() ? "game_pad_tutorial" : MAIN_ASSETS->isUsingDesktopTextureSet() ? "d_tutorial" : MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_tutorial" : "tutorial", true)),
m_vampire(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_vampire" : "vampire", true)),
m_world_1_background_lower_part_1(new TextureWrapper("world_1_background_lower_part_1", false, true)),
m_world_1_background_lower_part_2(new TextureWrapper("world_1_background_lower_part_2", false, true)),
m_world_1_background_mid(new TextureWrapper("world_1_background_mid", false, true)),
m_world_1_background_upper(new TextureWrapper("world_1_background_upper", false, true)),
m_world_1_cutscene_1(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_cutscene_1" : "world_1_cutscene_1", true)),
m_world_1_cutscene_2(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_cutscene_2" : "world_1_cutscene_2", true)),
m_world_1_end_boss_part_1(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_end_boss_part_1" : "world_1_end_boss_part_1", true)),
m_world_1_end_boss_part_2(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_end_boss_part_2" : "world_1_end_boss_part_2", true)),
m_world_1_end_boss_part_3(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_end_boss_part_3" : "world_1_end_boss_part_3", true)),
m_world_1_enemies(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_enemies" : "world_1_enemies", true)),
m_world_1_ground(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_ground" : "world_1_ground", true)),
m_world_1_mid_boss_part_1(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_mid_boss_part_1" : "world_1_mid_boss_part_1", true)),
m_world_1_mid_boss_part_2(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_mid_boss_part_2" : "world_1_mid_boss_part_2", true)),
m_world_1_mid_boss_part_3(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_mid_boss_part_3" : "world_1_mid_boss_part_3", true)),
m_world_1_objects_part_1(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_objects_part_1" : "world_1_objects_part_1", true)),
m_world_1_objects_part_2(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_objects_part_2" : "world_1_objects_part_2", true)),
m_world_1_special(new TextureWrapper(MAIN_ASSETS->isUsingCompressedTextureSet() ? "c_world_1_special" : "world_1_special", true)),
m_world_map_screen_part_1(new TextureWrapper("world_map_screen_part_1", true)),
m_world_map_screen_part_2(new TextureWrapper("world_map_screen_part_2", true)),
