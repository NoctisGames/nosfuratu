...
{
public:
    CaveEndLeft(int gridX) : Ground(gridX, 48, 8, 24, 0.08333333333333f, 0.20833333333334f, GroundType_CaveEndLeft, GROUND_SOUND_CAVE) {}
};

class CaveSmall : public Ground
{
public:
    CaveSmall(int gridX) : Ground(gridX, 48, 32, 24, 0.08333333333333f, 0.20833333333334f, GroundType_CaveSmall, GROUND_SOUND_CAVE) {}
};

class CaveMedium : public Ground
{
public:
    CaveMedium(int gridX) : Ground(gridX, 48, 64, 24, 0.08333333333333f, 0.20833333333334f, GroundType_CaveMedium, GROUND_SOUND_CAVE) {}
};

class CaveLarge : public Ground
{
public:
    CaveLarge(int gridX) : Ground(gridX, 48, 128, 24, 0.08333333333333f, 0.20833333333334f, GroundType_CaveLarge, GROUND_SOUND_CAVE) {}
};

class CaveEndRight : public Ground
{
public:
    CaveEndRight(int gridX) : Ground(gridX, 48, 8, 24, 0.08333333333333f, 0.20833333333334f, GroundType_CaveEndRight, GROUND_SOUND_CAVE) {}
};
...
{
public:
    GrassWithCaveEndLeft(int gridX) : Ground(gridX, 88, 8, 12, 0.16666666666667f, 0.5f, GroundType_GrassWithCaveEndLeft, GROUND_SOUND_GRASS) {}
};

class GrassWithCaveSmall : public Ground
{
public:
    GrassWithCaveSmall(int gridX) : Ground(gridX, 88, 32, 12, 0.16666666666667f, 0.5f, GroundType_GrassWithCaveSmall, GROUND_SOUND_GRASS) {}
};

class GrassWithCaveMedium : public Ground
{
public:
    GrassWithCaveMedium(int gridX) : Ground(gridX, 88, 64, 12, 0.16666666666667f, 0.5f, GroundType_GrassWithCaveMedium, GROUND_SOUND_GRASS) {}
};

class GrassWithCaveLarge : public Ground
{
public:
    GrassWithCaveLarge(int gridX) : Ground(gridX, 88, 128, 12, 0.16666666666667f, 0.5f, GroundType_GrassWithCaveLarge, GROUND_SOUND_GRASS) {}
};

class GrassWithCaveEndRight : public Ground
{
public:
    GrassWithCaveEndRight(int gridX) : Ground(gridX, 88, 8, 12, 0.16666666666667f, 0.5f, GroundType_GrassWithCaveEndRight, GROUND_SOUND_GRASS) {}
};
