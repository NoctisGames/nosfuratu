...
#define REQUESTED_ACTION_UNLOCK_ACHIEVEMENT 3
#define REQUESTED_ACTION_DISPLAY_LEADERBOARDS 4
#define REQUESTED_ACTION_DISPLAY_ACHIEVEMENTS 5
#define REQUESTED_ACTION_SIGN_IN 6
#define REQUESTED_ACTION_SIGN_OUT 7
